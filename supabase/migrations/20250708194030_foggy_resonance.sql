/*
  # Fix Content Provider Matching Issues

  1. Database Schema Updates
    - Add provider_type enum for better categorization
    - Add is_network, network_id, country_of_origin columns to providers
    - Add availability_type, quality, audio/subtitle language support to content_providers
    - Insert Turkish networks with correct TMDB network IDs

  2. Provider Categorization
    - Streaming platforms (Netflix, Amazon Prime, etc.)
    - Networks (Exxen, Show TV, BBC One, etc.)
    - Digital purchase (iTunes, Google Play, etc.)
    - Free platforms (YouTube, ad-supported services)

  3. Performance Improvements
    - Add indexes for provider_type, is_network, network_id
    - Optimize content provider queries
*/

/*
  ...
  1. Changes
    ...
    - Add is_network field to identify network providers
    - Add network_id field for TMDB network mapping
    - Add country_of_origin field for regional platforms
    - Ensure all provider information is available to frontend

  2. Security
    - Maintains existing security settings
    - View remains accessible to authenticated and anonymous users
*/
